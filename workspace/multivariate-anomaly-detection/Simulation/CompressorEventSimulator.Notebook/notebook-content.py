...
scada_event_hub_connection_string = get_eventstream_connection_string(eventstream_name = "ScadaEventsEventStream", eventstream_source_name = "ScadaEvents-Source")
anomalies_event_hub_connection_string  = get_eventstream_connection_string(eventstream_name = "AnomaliesEventStream", eventstream_source_name = "Anomalies-Source")
